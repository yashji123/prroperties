...
$(window).on('load', function() {
    $('#preloaderInner').fadeOut(50); // Fade out duration for inner preloader
    $('#preloader')
        .delay(20) // Delay before starting to fade out the preloader
        .fadeOut(50); // Fade out duration for the preloader
    $('body')
        .delay(20); // Adjusting delay for the body
});
// Preloader End
