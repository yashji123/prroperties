...
class KycVerificationService
{
        ...
        return datatables($kycVerifications)
            ...
            ->addColumn('action', function ($data) {
                return '<div class="tbl-action-btns d-inline-flex">
                        ...
                        <button onclick="deleteItem(\'' . route('owner.documents.delete', $data->id) . '\', \'allDataTable\')" class="p-1 tbl-action-btn"   title="' . __('Delete') . '"><span class="iconify" data-icon="ep:delete-filled"></span></button>
                    </div>';
            })
    ...
    {
        $kycVerifications = KycVerification::where('tenant_id', $id)->get();
