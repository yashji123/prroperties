...
function getDurationTypes($input = null)
{
    $output = [
        ...
        DURATION_TYPE_FOR_SALE => __('For Sale'),
        DURATION_TYPE_FOR_DAILY => __('For Night'),
        DURATION_TYPE_FOR_WEEKLY => __('For Weekly'),
    ];
...
{
    $output = [
        PROPERTY_ADVANTAGE_PETS_ALLOWED => __('For commercial'),
          PROPERTY_ADVANTAGE_FOR_RENT => __('For rent'),
        PROPERTY_ADVANTAGE_FOR_SALE => __('For sale'),
