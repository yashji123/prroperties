...
Route::group(['prefix' => 'owner', 'as' => 'owner.', 'middleware' => ['auth', 'owner']], function () {
    ...
    Route::post('/owner/bank-details', [DashboardController::class, 'storeBankDetails'])->name('owner.storeBankDetails');

    Route::group(['prefix' => 'property', 'as' => 'property.'], function () {
        
        Route::get('all-property', [PropertyController::class, 'allProperty'])->name('allProperty');
        //yash
          Route::get('referral', [PropertyController::class, 'referral'])->name('referral');
