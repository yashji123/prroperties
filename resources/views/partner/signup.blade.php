                    ...
                    <div class="col-md-6">
                        <div class="sign-up-right-content bg-white">
                            <form action="{{ route('owner.register.store') }}" method="post">
                                ...
                                <h1 class="mb-25">{{ __('Partner Portal') }}</h1>
                                <p class="font-16 mb-30">{{ __('Already have an account?') }} <a href="{{ route('partner.login') }}"
                                ...
                                <div class="row mb-25">
                                    <div class="col-md-12 mb-25">
                                        ...
                                        <div class="form-group mb-0 position-relative">
                                            <input class="form-control" name="password" placeholder="{{ __('********') }}"
                                                type="password">
                                        </div>
                                        @error('password')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12 mb-25">
                                        <label
                                            class="label-text-title color-heading font-medium mt-10">{{ __('Referral Code*') }}</label>
                                        <div class="form-group mb-0 position-relative">
                                        <input class="form-control" type="text" name="referred_by" required placeholder="Referral Code" />
                                        <input type="hidden" name="partner_code" value="this_partner" />
                                        </div>
                                    </div>
                                </div>
