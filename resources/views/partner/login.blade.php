...
@section('content')
    <div id="headless-wrapper">
        <section class="sign-up-page bg-light-gray1">
                ...
                <div class="row sign-up-page-wrap-row">
                    <div class="col-md-6">
                        <div class="sign-up-right-content">
                            <form action="{{ route('login') }}" method="post">
                                ...
                                <h1 class="mb-25">{{ __('Partner Login') }}</h1>
                                @if (isAddonInstalled('PROTYSAAS') > 1)
                                    <p class="font-16 mb-30">{{ __('New Partner?') }} <a
                                            href="{{ route('partner.signup') }}"
                    ...
                    <div class="col-md-6">
                        <div class="sign-up-left-content position-relative text-center">
                            ...
                            <!-- <img class="homec-shape-single homec-shape-1" src="{{ asset('frontend/assets/img/login-bg.jpg') }}" alt="icon">
