...
@section('content')
    ...
    <div class="modal fade" id="smsSendModal" tabindex="-1" aria-labelledby="smsSendModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smsSendModalLabel">{{ __('Send SMS') }}</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span
                            class="iconify" data-icon="akar-icons:cross"></span></button>
                </div>
                <form class="ajax" action="{{ route('sms-mail.sms.send') }}" method="POST" data-handler="getShowMessage">
    ...
    <input type="hidden" id="route" value="{{ route('sms-mail.sms') }}">
...
@push('script')
    ...
    <script src="{{ asset('assets/js/custom/sms-mail/sms.js') }}"></script>
@endpush
