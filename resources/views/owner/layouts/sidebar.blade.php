    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    @if (getOption('LISTING_STATUS', 0) == ACTIVE)
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li>
                                    <a href="{{ route('owner.listing.contact') }}">{{ __('Booking Request') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                ...
                @if(isset($partnerCode) && $partnerCode === 'this_partner')
                <li>
                    <a href="{{ route('owner.property.referral') }}">
                ...
                <li>
                    <a href="https://booking.renesent.net/">
                        <i class="ri-truck-line"></i>
                        <span>{{ __('Relocation') }}</span>
                    </a>
                </li>
