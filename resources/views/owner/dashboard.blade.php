...
@section('content')
                        ...
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <div class="page-title-left">
                                    ...
                                    <a href="javascript:void(0);" onclick="copyReferralCode()">
                                         <i class="ri-share-forward-line"></i>
                                             <span id="referralCode">Referral Code: {{ $referralCode ?? 'N/A' }} | {{ $referralCount }}</span>
    ...
    function copyReferralCode() {
        ...
        textArea.value = document.getElementById('referralCode').innerText;
