            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
                    <div class="homec-section__head text-center mg-btm-30">
                        <span class="homec-section__badge homec-primary-color homec-section__badge--small m-0">Get our information </span>
                        <h2 class="homec-section__title">Our latest news</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="homec-blog__head">
                            ...
                            <div class="homec-blog__content">
                                ...
                                <div class="home-blog__button homec-border-top">
                                    <a href="/how-to-choose-the-right-real-estate-agent" class="homec-blog__btn">Read More
