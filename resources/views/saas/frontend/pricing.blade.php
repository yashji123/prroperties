                ...
                <span class="value">Try 1 month free! CODE: PRRSOFT23</span>
                    <div class="content">
                        ...
                        <div class="price-container">
                            <span class="price basic-price " style="font-size: 52px;">$1.50</span>
                            <span class="plan-duration">/ Per Door <span class="mob-brk">/ Per Month</span></span>
                        </div>

                        <div class="number-door d-flex align-item-center description justify-content-space">
                            <div>No of Doors: <input type="number" id="software-doors" value="0" min="0" oninput="updatePrice('software', 1.50)">
                            </div>
...
<section class="homec-bg-cover service-features pd-top-90 pd-btm-60 homec-featured-property-bg pricing-tab" id="pricingTab">
    <div class="col-12">
        <!-- Section TItle -->
    ...
    <div class="container">
        ...
        <div class="d-flex align-items-start">
            <div class="col-md-3">
                <div class="nav flex-column nav-pills nav-pills-custom me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <button class="nav-link mb-3 p-4 shadow" id="v-pills-maintenance-tab" data-bs-toggle="pill" data-bs-target="#v-pills-maintenance" type="button" role="tab" aria-controls="v-pills-maintenance" aria-selected="false">
                        <span class="font-weight-bold small">Maintenance</span></a>
                    </button>
                    <button class="nav-link mb-3 p-4 shadow d-none" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">
            ...
            <div class="col-md-9">
                <div class="tab-content accordion nav-pills-custom" id="v-pills-tabContent">

                    <div class="tab-pane fade shadow rounded bg-white show active p-3 accordion-item" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
                        <h2 class="accordion-header d-lg-none" id="headingOne">
                            <button class="accordion-button nav-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Software</button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse d-lg-block" aria-labelledby="headingOne" data-bs-parent="#v-pills-tabContent">
                    ...
                    <div class="tab-pane fade shadow rounded bg-white p-3 accordion-item" id="v-pills-maintenance" role="tabpanel" aria-labelledby="v-pills-maintenance-tab" tabindex="0">
                        <h2 class="accordion-header d-lg-none" id="headingTwo">
                            <button class="accordion-button nav-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">Maintenance standard</button>
                        </h2>
                        <div id="collapseTwo" class="accordion-collapse collapse d-lg-block" aria-labelledby="headingTwo" data-bs-parent="#v-pills-tabContent">
                            <div class="accordion-body">
                                <ul class="homec-psingle__list d-flex justify-content-space">
                                    <div class="col-md-6">
                                        <li><span class="homec-psingle__icon homec-check-color"><i class="fas fa-check"></i></span>Scheduled inspections</li>
                    ...
                    <div class="tab-pane fade shadow rounded bg-white p-3 accordion-item" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab" tabindex="0">
                        <h2 class="accordion-header d-lg-none" id="headingThree">
                            <button class="accordion-button nav-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">Maintenance pro</button>
                        </h2>
                        <div id="collapseThree" class="accordion-collapse collapse d-lg-block" aria-labelledby="headingThree" data-bs-parent="#v-pills-tabContent">
                            <div class="accordion-body">
                                <ul class="homec-psingle__list d-flex justify-content-space">
                                    <div class="col-md-6">
                                        <li><span class="homec-psingle__icon homec-check-color"><i class="fas fa-check"></i></span>Scheduled inspections</li>
                    ...
                    <div class="tab-pane fade shadow rounded bg-white p-3 accordion-item" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab" tabindex="0">
                        <h2 class="accordion-header d-lg-none" id="headingFour">
                            <button class="accordion-button nav-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">Property management   </button>
                        </h2>
                        <div id="collapseFour" class="accordion-collapse collapse d-lg-block" aria-labelledby="headingFour" data-bs-parent="#v-pills-tabContent">
                            <div class="accordion-body">
                                <ul class="homec-psingle__list d-flex justify-content-space">
                                    <div class="col-md-6">
                                        <li><span class="homec-psingle__icon homec-check-color"><i class="fas fa-check"></i></span>All-in-one technology to manage properties and tenants</li>
...
<section class="homec-bg-cover pd-top-70 pd-btm-90 homec-faq-bg pricing-faq  mg-btm-40">
    <div class="container homec-container-medium">
                ...
                <div class="homec-accordion accordion accordion-flush" id="homec-accordion">
                    ...
                    <div class="accordion-item homec-accordion__single mg-top-30">
                        ...
                        <div id="ac-collapse1-2" class="accordion-collapse collapse " data-bs-parent="#homec-accordion">
                            <div class="accordion-body homec-accordion__body"> 
                                <p>Our Software All-in-one CRM service is priced at $1.5 per door per month. You will be billed based on the number of doors you manage. The total cost is calculated by multiplying the number of doors by $1.5.</p>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Accordion -->
        ...
        <div class="modal-content">
            ...
            <!-- Form left part start  -->
                <div class="col-md-6 price-form">
                    <h2 class="mg-btm-40">Payment Details</h2>
                    <h4>Choose plan for <span id="selected-plan-display"></span></h4>
                    <div class="price-container">
            <span id="price-per-door-display" class="price basic-price ">$1</span>
                        <span class="plan-duration">/ Per Door / Per Month</span>
                    </div>

                    <div class="price-container d-flex justify-content-space mg-top-30">
                        <span class="basic-price ">No of Doors</span>
                    <span id="number-of-doors-display" class="plan-duration">10</span>
                    </div>

                    <div class="price-container d-flex justify-content-space mg-btm-10">
                        <span class="basic-price ">No of Doors Total</span>
                        <span  class="plan-duration total-price-display">$150</span>
                    </div>

                    <div class="total-wrap">
                        <div class="total-box pd-top-10 pd-btm-10 total-box-bor">
                            <div class="total-head">Subtotal</div>
                            <div class="total-price total-price-display">$150.00</div>
                        </div>
                        <div class="total-box pd-btm-10">
                            <div class="total-head">Discount</div>
                            <div class="total-price "><span id="discount-sign">0%</span></div>
                        </div>
                        <div class="total-box total-box-bor big-font pd-btm-10 pd-top-10">
                            <div class="total-head">Total due today</div>
                            <div class="total-price "><span id="display-amount"></span></div>
                        </div>
                    </div>
                </div>
                <!-- Form left part end  -->
...
function updatePrice(plan, pricePerDoor) {
    ...
    if (plan === selectedPlan) {
        ...
        document.getElementById('number-of-doors-display').innerText = numberOfDoors;
        var priceDisplays = document.querySelectorAll('.total-price-display');
...
function choosePlan(planType) {
    ...
    document.getElementById('selected-plan-display').innerText = planType.charAt(0).toUpperCase() + planType.slice(1);
    document.getElementById('price-per-door-display').innerText = '$' + pricePerDoor;
...
function applyDiscount() {
    ...
    var discountSignElement = document.getElementById('discount-sign');
    
    // Retrieve the current total amount from the 'payment-amount' field
    var originalAmount = parseFloat(document.getElementById('payment-amount').value);
    var discountedAmount;

    if (discountCode === 'PRRSOFT23') {
        discountedAmount = 0; // 100% discount
        discountSignElement.innerText = '100%';
    } else if (discountCode === 'NICK10' || discountCode === 'TOM10') {
        discountedAmount = originalAmount * 0.9; // 10% discount
        discountSignElement.innerText = '10%';
    } else {
        discountedAmount = originalAmount; // No discount
        discountSignElement.innerText = '0%';
    }

    // Update the payment amount and the displayed amount
    document.getElementById('payment-amount').value = discountedAmount;
    document.getElementById('display-amount').innerText = '$' + discountedAmount.toFixed(2);
}
