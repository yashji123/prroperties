...
We may make changes to these Terms of Service from time to time. If we do this, we will post the changed Terms of Service on the Site and indicate at the top of this page the date the Terms of Service were last revised. You understand and agree that your continued use of the Service or the Site after we have made any such changes constitutes your acceptance of the new Terms of Service.
...
● submit content that falsely expresses or implies that such content is sponsored or endorsed by Prroperties, any of its affiliates or any third parties;
...
Prroperties: 514 North California Ave. Suite 0 Beaumont CA 92223

Telephone Number of Designated Agent: (415)212-5211

E-Mail Address of Designated Agent: support@Prroperties.com
...
Because Prroperties operates largely on the Internet, it is necessary for you to consent to transact business with us online and electronically. Before you decide to do business electronically with Prroperties, you must satisfy the following computer hardware and software requirements: access to the Internet; an email account and related software capable of receiving email through the Internet; a web browser which is SSL-compliant and supports secure sessions, such as Internet Explorer 5.0 or above and Netscape Navigator 6.0 or above, or the equivalent software; and hardware capable of running this software.

Prroperties generally receives all payments, and makes all disbursements, through electronic funds transfers (ACH transfers) using the bank (or other financial institution) account information you provide to us. You authorize such bank or other financial account to pay any amounts described herein, and authorize Prroperties to make any and all investment disbursements, to such account. You agree to provide Prroperties updated information regarding your bank or other account upon Prroperties's request and at any time that the information earlier provided is no longer valid.

As part of doing business with Prroperties, you must also consent to our giving you certain disclosures electronically, either via our Site or to the email address you provide to us. By agreeing to the Terms of Service, you agree to receive electronically all documents, communications, notices, contracts, and agreements, including any IRS Form 1099 or other tax forms, schedules or information statements, arising from or relating to your registration as an investor on our Site, any investments you may make, your use of this Service, and the servicing of any investment you may make (each, a "Disclosure"), from Prroperties or any service provider we may use. An IRS Form 1099 refers to any Form 1099 or other Form, Schedule or information statement, including corrections of such documents, required to be provided pursuant to the U.S. Internal Revenue Service rules and regulations and that may be provided electronically (each, an "IRS Form 1099"). The decision to do business with Prroperties electronically is yours. This document informs you of your rights concerning Disclosures.

Your consent to receive Disclosures and transact business electronically, and our agreements to do so, applies to any transactions to which such Disclosures relate, whether between you and Prroperties. Your consent will remain in effect for so long as you are a User and, if you are no longer a User, will continue until such a time as all Disclosures relevant to transactions that occurred while you were a User have been made.
...
EXCEPT IN JURISDICTIONS WHERE SUCH PROVISIONS ARE RESTRICTED AND EXCEPT AS MAY BE REQUIRED BY APPLICABLE SECURITIES LAWS, IN NO EVENT WILL Prroperties OR ITS DIRECTORS, OFFICERS, STOCKHOLDERS, PARTNERS, EMPLOYEES OR REPRESENTATIVES BE LIABLE TO YOU OR ANY THIRD-PARTY FOR ANY INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL OR PUNITIVE DAMAGES, INCLUDING FOR ANY LOST PROFITS OR LOST DATA ARISING FROM YOUR USE OF THE SITE OR THE SERVICE OR ANY OF THE SITE CONTENT OR OTHER MATERIALS ON OR ACCESSED THROUGH THE SITE, EVEN IF THE COMPANY IS AWARE OR HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.

NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, EXCEPT AS MAY BE REQUIRED BY APPLICABLE SECURITIES LAW OR OTHER LAWS, YOU SHALL BE LIMITED TO INJUNCTIVE RELIEF ONLY, AND SHALL NOT BE ENTITLED TO DAMAGES OF ANY KIND FROM ANY OF Prroperties OR ITS DIRECTORS, OFFICERS, STOCKHOLDERS, PARTNERS, EMPLOYEES OR REPRESENTATIVES, REGARDLESS OF THE CAUSE OF ACTION.
...
By visiting or using the Site and/or the Service, you agree that the laws of the State of California, without regard to any principles of conflict of laws that would require or permit the application of the laws of any other jurisdiction, will govern these Terms of Service.

By agreeing to the Terms and using the Website and the Service, you agree to submit to personal jurisdiction in Florida for all purposes, and you agree to waive, to the maximum extent permitted by law, any right to a trial by jury for any matter.

Unless otherwise agreed in writing by you and us, any dispute arising out of or relating to the Terms, or any breach thereof, shall be finally resolved by binding arbitration administered by the American Arbitration Association under its Commercial Arbitration Rules, or such arbitration body as required by law, rule or regulation, and a final judgment upon the award rendered by the arbitrator may be entered in any court having jurisdiction. The arbitration will be conducted in the English language before a single arbitrator in California. Such arbitration must be commenced within one (1) year after the claim or cause of action arises. Notwithstanding the foregoing, either Prroperties or you may apply to any court of competent jurisdiction for injunctive relief without breach of this arbitration provision.
...
Please visit our FAQ page for more information; you may also contact us via email at support@Prroperties.com.
