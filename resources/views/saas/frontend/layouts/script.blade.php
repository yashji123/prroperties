...
<script src="{{ asset('assets/libs/jquery/jquery-3.6.0.min.js') }}" async ></script>
<script src="{{ asset('frontend/assets/vendor/jquery/popper.min.js') }}" defer ></script>
<script src="{{ asset('frontend/assets/vendor/bootstrap/js/bootstrap.min.js') }}" defer></script>


{{-- <script src="assets/js/jquery-ui.min.js"></script> --}}
<script src="{{ asset('frontend/assets/js/jquery-migrate.js') }}" defer ></script>
<!-- <script src="{{ asset('assets/libs/jquery-ui/jquery-ui.min.js') }}"></script> -->
<script src='https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js' ></script>

<!-- ==== Plugin JavaScript ==== -->
{{-- <script src="assets/vendor/jquery-easing/jquery.easing.min.js" defer></script> --}}
<script src="{{ asset('frontend/assets/js/easing.min.js') }}" defer ></script>

<!-- Waypoints JS -->
<script src="{{ asset('frontend/assets/js/waypoints.min.js') }}" defer  ></script>
...
" defer></script>
<script src="{{ asset('frontend/assets/js/flex-slider.js') }}" defer ></script>

{{-- <script src="assets/js/owl.carousel.min.js"></script> --}}
<script src="{{ asset('assets/libs/owl-carousel/owl.carousel.min.js') }}"></script>

<!-- Select2 JS-->
<script src="{{ asset('frontend/assets/js/select2-js.min.js') }}" defer ></script>
...
<script src="{{ asset('assets/js/iconify.min.js') }}" defer ></script>
<script src="{{ asset('assets/js/custom/common.js') }}" defer ></script>
...
<script>
    (function($) {
        ...
        var swiper = new Swiper(".homec-slider-agent__card", {
                ...
                /*  Career core slider 1 */
                var swiper = new Swiper(".career-core-sliderOne", {
                        autoplay: {
                                delay: 2500,
                        },
                        navigation: {
                        ...
                        centeredSlides: false,
                        pagination: {
                                el: '.swiper-pagination__featuredOne',
                                type: 'bullets',
                                clickable: true,
                        },
                        slidesPerView: "1",
                ...
                /*  Career core slider 2 */
                var swiper = new Swiper(".career-core-sliderTwo", {
                        autoplay: {
                                delay: 3000,
                        },
                        navigation: {
                        ...
                        centeredSlides: false,
                        pagination: {
                                el: '.swiper-pagination__featuredTwo',
                                type: 'bullets',
                                clickable: true,
                        },
                        slidesPerView: "1",
                ...
                /*  Career core slider 3 */
                var swiper = new Swiper(".career-core-sliderThree", {
                        autoplay: {
                                delay: 3500,
                        },
                        navigation: {
                        ...
                        centeredSlides: false,
                        pagination: {
                                el: '.swiper-pagination__featuredThree',
                                type: 'bullets',
                                clickable: true,
                        },
                        slidesPerView: "1",
