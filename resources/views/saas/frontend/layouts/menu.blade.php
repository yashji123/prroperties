                ...
                <ul class="nav-menu menu navigation list-none">
                    ...
                    <li class="menu-item-has-children"><a href="#">Services</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="/construction-design">Develop & Renovate</a></li>
                            <li><a href="/relocation">Relocation</a></li>
                            <li><a href="/invest">Investment</a></li>
                        </ul>
                    </li>
                    <li><a href="/hosts">Landlords</a></li>
                    <li><a href="/explore">Tenants</a></li>
                    ...
                    <li class="menu-item-has-children"><a href="javascript:;">Location</a>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children"><a href="#">Explore</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="/prroperties-vs-vacation-rentals">Prroperties vs. Vacation Rentals</a></li>
                            <li><a href="/marketing-and-rentals">Prroperties Marketing & Rentals</a></li>
                            <li><a href="/payments-and-collections">Prroperties Payments & Collections</a></li>
                    ...
                    <li class="menu-item-has-children"><a href="javascript:;">Landlord</a>
                        <ul class="sub-menu">
                            ...
                            <div class="navbar">
                                <div class="nav-item">
                                    ...
                                    <ul class="nav-menu menu navigation list-none">
                                        ...
                                        <li><a href="/properties">Locations</a>
                                            <!-- <ul class="sub-menu">
                                                <li><a href="/properties">California</a></li>
                                                <li><a href="/properties">Florida</a></li>
                                            </ul> -->
                    ...
                    <div class="homec-header__button">
                        ...
                        <div class="dropdown cust-dropdown-toggle">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="/partner/login">Partner</a></li>
                            </ul>
                        </div>
