                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="homec-testimonial homec-border">
                                ...
                                <!-- Testimonial Text -->
                                <p class="homec-testimonial__text">“I can't express how grateful I am to Prroperties for their exceptional service. They took care of everything, from finding reliable tenants to maintaining my property. The peace of mind they've provided is priceless.”</p>
                                <div class="homec-testimonial__bottom mg-top-10">
                                    ...
                                    <div class="homec-testimonial__author">
                                        ...
                                        <div class="homec-testimonial__author--info">
                                            <h5 class="homec-testimonial__author--title">Gary Richard</h5>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="homec-testimonial homec-border">
                                ...
                                <!-- Testimonial Text -->
                                <p class="homec-testimonial__text">“Prroperties has made property ownership a breeze for me. Their attention to detail and commitment to excellence shine through in every interaction. Thanks to their expertise, my investments have never been more lucrative.”</p>
                                <div class="homec-testimonial__bottom mg-top-10">
                                    <!-- Testimonial Author -->
                                    <div class="homec-testimonial__author">
                                        <img src="{{ asset('frontend/assets/img/testimonials/david-simmons.jpg') }}"  alt="image">
                                        <div class="homec-testimonial__author--info">
                                            <h5 class="homec-testimonial__author--title">Ryan Simmons</h5>
